  ...
  useEffect(() => {
    ...
    const updateImages = async () => {
      try {
        ...
        for (const [idPropiedad, nuevasImagenes] of Object.entries(updatedImagesProperties)) {
          const propertyRef = doc(db, "propiedades", idPropiedad);
          await updateDoc(propertyRef, { FotosPropiedad: nuevasImagenes });
          console.log(`imagenes de la propiedad: "${idPropiedad}" actualizadas correctamente.`);
